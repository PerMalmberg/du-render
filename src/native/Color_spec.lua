...
describe("Color", function()
    ...
    it("Can read hex format", function()
        assert.are_equal(Color.New(1, 1, 1, 1), Color.FromString("    #FFFFFFFF  "))
        assert.are_equal(Color.New(0, 1, 0, 1), Color.FromString("# 00FF00FF"))
    end)
end)
